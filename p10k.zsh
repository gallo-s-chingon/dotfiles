# Generated by Powerlevel10k configuration wizard on 2024-05-17 at 00:46 PDT. Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 4242. Wizard options: nerdfont-v3 + powerline, small icons, unicode, lean, 24h time, 2 lines, disconnected, no frame, sparse, many icons, concise, transient_prompt,
# instant_prompt=quiet.
# Type `p10k configure` to generate another config. Config for Powerlevel10k with lean prompt style. Type `p10k configure` to generate your own config based on it.
